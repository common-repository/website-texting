...
if (!function_exists('LeadSMSAutoload')) {
    /**
     * Plugin autoloader.
     *
     ...
     * @param $class
     */
    function LeadSMSAutoload($class)
    {
    ...
    spl_autoload_register('LeadSMSAutoload');
}


$settings = new \LeadSMS\Classes\Settings();
$settings->bootAjaxActions();